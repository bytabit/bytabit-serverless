...
@Slf4j
public class GetAllArbitrateTradeHandler extends WebRequestHandler {

    private TradeManager tradeManager = new TradeManager();

    private final Gson gson;

    public GetAllArbitrateTradeHandler() {
    ...
    public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
        try {
            ...
            List<TradeServiceResource> trades = tradeManager.getAllArbitrate(version);
