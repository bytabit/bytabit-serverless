...
@Slf4j
public class GetByOfferTradeHandler extends WebRequestHandler {

    private TradeManager tradeManager = new TradeManager();

    private final Gson gson;

    public GetByOfferTradeHandler() {
    ...
    public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
        try {
            ...
            String offerId = getPathParameter(input, "id");
            ...
            List<TradeServiceResource> trades = tradeManager.getByOfferId(offerId, version);
